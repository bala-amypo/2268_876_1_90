...
public DuplicateRuleServiceImpl(DuplicateRuleRepository 
...
if 
(duplicateRuleRepository.findByRuleName(rule.getRuleName()).isPresent()
) { 
throw new IllegalArgumentException("exists"); 
} 
if (rule.getThreshold() == null || rule.getThreshold() < 0.0 || 
...
return duplicateRuleRepository.findById(id).orElseThrow(() -> 
